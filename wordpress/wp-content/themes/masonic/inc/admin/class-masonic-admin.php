...
class Masonic_Admin {
	...
	public function admin_menu() {
		...
		$page = add_theme_page( esc_html__( 'About', 'masonic' ) . ' ' . $theme->display( 'Name' ), esc_html__( 'About', 'masonic' ) . ' ' . $theme->display( 'Name' ), 'activate_plugins', 'masonic-welcome', array( $this, 'welcome_screen' ) );
	...
	private function intro() {
		...
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab <?php if ( empty( $_GET['tab'] ) && $_GET['page'] == 'masonic-welcome' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'masonic-welcome' ), 'themes.php' ) ) ); ?>">
				<?php echo $theme->display( 'Name' ); ?>
			</a>
			<a class="nav-tab <?php if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'supported_plugins' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'masonic-welcome', 'tab' => 'supported_plugins' ), 'themes.php' ) ) ); ?>">
				<?php esc_html_e( 'Supported Plugins', 'masonic' ); ?>
			</a>
			<a class="nav-tab <?php if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'changelog' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'masonic-welcome', 'tab' => 'changelog' ), 'themes.php' ) ) ); ?>">
